...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FirstPersonController_Start_m4F55349288CAEA1EE6BC9809DEE275A02451589F (FirstPersonController_t401750B3FF66376716EB94B8F5A9DA4097F9918D* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_5 = __this->___m_StepCycle;
		__this->___m_NextStep = ((float)(L_5/(2.0f)));
		...
		__this->___m_AudioSource = L_6;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_AudioSource), (void*)L_6);
		MouseLook_t1EF72459BE77FC81E6D3AD87B1020A50800F5894* L_7 = __this->___m_MouseLook;
		...
		MouseLook_Init_m7086DCA60BBC6F28FD3DCBFB78828D578656D9E6(L_7, L_8, L_10, NULL);
		return;
	}
}
...
IL_001e:
	...
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_5 = (Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)(&__this->___m_MoveDir);
		L_5->___y = (0.0f);
		__this->___m_Jumping = (bool)0;
	}
...
IL_0050:
	{
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_6 = __this->___m_CharacterController;
		bool L_7;
	...
	{
		bool L_9 = __this->___m_PreviouslyGrounded;
		if (!L_9)
		{
			goto IL_007d;
		}
	...
	{
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_10 = (Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)(&__this->___m_MoveDir);
		L_10->___y = (0.0f);
	}
...
IL_007d:
	{
		...
		__this->___m_PreviouslyGrounded = L_12;
		return;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FirstPersonController_PlayLandingSound_m336EF9D77C24FB1ABBB047C0146971E853079191 (FirstPersonController_t401750B3FF66376716EB94B8F5A9DA4097F9918D* __this, const RuntimeMethod* method) 
...
IL_0012:
	{
		bool L_1;
		L_1 = Input_GetKeyDown_mB237DEA6244132670D38990BAB77D813FBB028D2(((int32_t)112), NULL);
		if (!L_1)
		{
			goto IL_0022;
		}
...
IL_0047:
	{
		bool L_4 = __this->___m_cursorIsLocked;
		if (L_4)
		{
			goto IL_005b;
		}
